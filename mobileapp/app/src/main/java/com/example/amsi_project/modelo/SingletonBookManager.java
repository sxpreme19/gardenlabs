...
public class SingletonBookManager {
    ...
    //public static final String mUrlAPILivros = "http://amsi.dei.estg.ipleiria.pt/api/livros";
    //public static final String mUrlAPILogin = "http://amsi.dei.estg.ipleiria.pt/api/auth/login";
