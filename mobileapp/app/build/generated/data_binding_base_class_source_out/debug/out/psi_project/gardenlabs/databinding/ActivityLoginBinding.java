...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
      ...
      @NonNull TextInputLayout passwordInputLayout, @NonNull Button registerBtn,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, imageView, loginBtn, main,
          passwordInputLayout, registerBtn, textView, textView2, usernameInputLayout);
    }
